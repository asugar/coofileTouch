...
public class RegionLogBean {
	...
	public String toString() {
		...
		// .append(",'").append(sceneName).append("',").append(regionId).append(",'").append(regionName)
		...
		// .append(regionName).append("','").append(elementName).append("',").append(type).append(",")
		// .append(life).append(",'").append(startTime).append("','").append(endTime).append("';")
		// .append("\r\n").toString();
		return MessageFormat.format(messageFormat, programName, sceneName, regionName, elementName, type, life,
						startTime, endTime);
	}

	public RegionLogBean(ProgramBean program, SceneBean scene, ElementBean element) {
		this.programId = program.getId();
		this.programName = program.getName();
		this.sceneId = scene.getId();
		this.sceneName = scene.getName();
		RegionBean region = element.getRegion();
		if (region != null) {
